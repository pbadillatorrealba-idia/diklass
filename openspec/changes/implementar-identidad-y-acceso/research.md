...
**Contexto histórico de 2026-09-09:** el registro original indicaba que el repositorio no contenía código de aplicación. Estas decisiones describían una base nueva para una
PoC móvil universal, con iOS, Android y un target web app-like. Se conservan las versiones y fuentes consultadas como historia de diseño, no como una auditoría del estado actual. El gobierno vigente está en la [constitución](../../../docs/constitution.md) y la reconciliación histórica del SDK está registrada en [design.md](design.md#historial-de-decisiones-sobre-el-sdk).
