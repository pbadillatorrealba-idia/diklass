# Diseño de implementación: Identidad y acceso

**Fecha original del diseño**: 2026-09-09 | **Especificación**: [Identidad y acceso](specs/identidad-y-acceso/spec.md)

**Entrada**: intención documentada en la especificación de identidad y acceso.

> **Estado histórico:** se conservan las decisiones, presupuestos y declaraciones de compuertas del diseño original; no son verificaciones realizadas durante esta migración. Identidad está parcialmente implementada y pendiente de aceptación; T045 sigue pendiente y US12 se acepta conjuntamente con registro clínico longitudinal. La [constitución vigente](../../../docs/constitution.md) gobierna este diseño.

## Documentos de soporte

- [Investigación y decisiones técnicas](research.md).
- [Modelo de datos](data-model.md).
- [Guía de validación y evidencia histórica](quickstart.md).
- [Contrato de autenticación y sesión](contracts/auth-session.md).
- [Contrato de atribución clínica](contracts/clinical-attribution.md).
- [Tareas y estados históricos](tasks.md).
- [Checklist de revisión documental](checklists/requirements.md).
...
implementa todavía las entidades completas de la especificación de [registro clínico longitudinal](../implementar-registro-clinico-longitudinal/specs/registro-clinico-longitudinal/spec.md) ni el ciclo de vida de cuentas.
...
- **I. Desarrollo dirigido por especificación — PASS**: este diseño parte de `specs/identidad-y-acceso/spec.md`; tareas y
...
```text
openspec/changes/implementar-identidad-y-acceso/
├── proposal.md
├── design.md
├── specs/identidad-y-acceso/spec.md
├── research.md
├── data-model.md
├── quickstart.md
├── contracts/
│   ├── auth-session.md
│   └── clinical-attribution.md
├── checklists/requirements.md
└── tasks.md             # registro de tareas de implementación
```
...
**Resultado final del gate (declaración histórica)**: PASS. El diseño se declaró listo para elaborar tareas. La secuencia vigente exige propuesta → especificaciones aprobadas y diseño → tareas → implementación → verificación → sincronización/archivo; las declaraciones históricas no sustituyen aceptación demostrada.
...
## Historial de decisiones sobre el SDK

El diseño y la investigación originales eligieron Expo SDK 57; la referencia primaria de Expo consultada en la investigación permanece en la rama SDK 56. El registro T047 documenta que la constitución fijaba SDK 56 mientras la implementación y estos soportes usaban SDK 57, y conserva como completada la reconciliación mediante enmienda normativa o reversión. Esa marca es histórica y no una comprobación nueva de versiones o implementación. Se conserva también la enmienda histórica 1.1.0 → 1.2.0 declarada arriba; para el gobierno actual prevalece la [constitución vigente](../../../docs/constitution.md), incluidas las compuertas nativas y web.
