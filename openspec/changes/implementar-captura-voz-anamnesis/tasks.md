...
- [ ] 1.1 Integrar la base clínica: `git merge feat/002-registro-clinico-longitudinal` y dejar el
...
- [ ] 1.2 Escribir `supabase/tests/010_captura_voz.sql` en rojo (pgTap, patrón de
...
- [ ] 2.1 Escribir en rojo `tests/unit/voz/schema.test.ts` y luego `src/features/voz/schema.ts`:
...
- [ ] 2.2 Escribir en rojo `tests/unit/voz/transcription-port.test.ts` y luego
...
- [ ] 2.3 Escribir en rojo `tests/unit/voz/extraction.test.ts` y luego
...
- [ ] 2.4 Escribir en rojo `tests/unit/voz/contradictions.test.ts` y luego
...
- [ ] 3.1 Escribir en rojo `tests/unit/voz/listen-session-service.test.ts` y
...
- [ ] 3.3 Escribir en rojo `tests/unit/voz/listen-mode-controller.test.ts` y luego
...
- [ ] 4.1 Implementar `src/components/voz/`: `ListenModeButton` e indicador de captura con
...
- [ ] 4.2 Implementar el panel de revisión de `ListenModeSection`: transcripción visible durante la
...
- [ ] 5.1 Escribir en rojo `tests/integration/voz/captura-voz.test.ts` (patrón
...
- [ ] 5.2 Ejecutar las compuertas locales disponibles y dejar la rama revisable: `bun run
  ...
  `quickstart.md`.
- [ ] 5.3 Consolidar `quickstart.md` del cambio con la evidencia real acumulada desde 1.2
...
- [ ] 6.1 Si la implementación desvía `design.md` o estas tareas, actualizar los artefactos antes
